...
ImporterApp.prototype.Init = function ()
{
	...
	top.innerHTML = [ '<div id="top"></div>'].join('');
	...
	importerButtons.AddButton ('content/images/openfile.png', 'Open File', function () { myThis.OpenFile (); });
	importerButtons.AddButton ('content/images/fitinwindow.png', 'Fit In Window', function () { myThis.FitInWindow (); });
	importerButtons.AddButton ('content/images/fixup.png', 'Enable/Disable Fixed Up Vector', function () { myThis.SetFixUp (); });
	importerButtons.AddButton ('content/images/top.png', 'Set Up Vector (Z)', function () { myThis.SetNamedView ('z'); });
	importerButtons.AddButton ('content/images/bottom.png', 'Set Up Vector (-Z)', function () { myThis.SetNamedView ('-z'); });
	importerButtons.AddButton ('content/images/front.png', 'Set Up Vector (Y)', function () { myThis.SetNamedView ('y'); });
	importerButtons.AddButton ('content/images/back.png', 'Set Up Vector (-Y)', function () { myThis.SetNamedView ('-y'); });
	importerButtons.AddButton ('content/images/left.png', 'Set Up Vector (X)', function () { myThis.SetNamedView ('x'); });
	importerButtons.AddButton ('content/images/right.png', 'Set Up Vector (-X)', function () { myThis.SetNamedView ('-x'); });
    ...
    fileInput.innerHTML = [ '<input type="file" id="file" style="display:none" multiple></input>'].join('');
...
ImporterApp.prototype.Resize = function ()
{
    ...
    left.innerHTML = ['<div id="left"><div id="menu"></div></div>'].join('');
    document.body.appendChild(left);

    var example = document.createElement("div");
    example.innerHTML = ['<canvas id="example" width="0" height="0"></canvas>'].join('');
