...
import com.proshape.service.MailService;
import com.proshape.service.UserService;
import com.proshape.service.dto.UserDTO;
import com.proshape.web.rest.vm.KeyAndPasswordVM;
import com.proshape.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = ProshapeApp.class)
public class AccountResourceIntTest {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), validUser.getLogin(), validUser.getPassword(), validUser.getFirstName(), validUser.getLastName(),
            "alicejr@example.com", true, validUser.getImageUrl(), validUser.getLangKey(), validUser.getCreatedBy(), validUser.getCreatedDate(), validUser.getLastModifiedBy(), validUser.getLastModifiedDate(), validUser.getAuthorities(),
             validUser.isGroupOwner(), validUser.isAcceptedInGroup());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), "johnjr", validUser.getPassword(), validUser.getLogin(), validUser.getLastName(),
            validUser.getEmail(), true, validUser.getImageUrl(), validUser.getLangKey(), validUser.getCreatedBy(), validUser.getCreatedDate(), validUser.getLastModifiedBy(), validUser.getLastModifiedDate(), validUser.getAuthorities(), validUser.isGroupOwner(),  validUser.isAcceptedInGroup());
